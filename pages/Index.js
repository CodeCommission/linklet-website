              ...
              <div>
                <div className="wow fadeInRight animated" data-wow-delay="0.3s">
                    <AboutInfoContainer>
                      ...
                      <AboutInfo>
                          <h3>Async/Await</h3>
                          <p>Designed and developed to simplify the usage of EcmaScript async/await for HTTP responses.</p>
                      </AboutInfo>
                    </AboutInfoContainer>
                </div>
              ...
              <div>
                <div className="wow fadeInLeft animated" data-wow-delay="0.3s">
                    <AboutInfoContainer>
                        ...
                        <AboutInfo>
                            <h3>Simplicity</h3>
                            <p>Applying "Simplest possible thing" - designed and developed to improve the development time of Microservices.</p>
                        </AboutInfo>
                    </AboutInfoContainer>
                </div>
                <div className="wow fadeInRight animated" data-wow-delay="0.6s">
                ...
                <div className="wow fadeInLeft animated" data-wow-delay="0.9s">
                    <AboutInfoContainer>
                      ...
                      <AboutInfo>
                          <h3>Ready to Run</h3>
                          <p>Comfortable setup and deployment to improve application release cycles.</p>
                      </AboutInfo>
                    </AboutInfoContainer>
                </div>
              </div>
